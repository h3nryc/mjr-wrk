...
socket.emit('getNotif', token, function(res){
  ...
  for (var i = 0; i < res.length; i++) {
    ...
    if (res[i].reason == "like") {
      ...
      $('#notif-ul').append('<li><img src="'+pp+'" class="avatar"> <span><a class="usr-link" href="/user/'+id+'"><span class="bold">'+id+'</span></a> liked your <a href="http://10.0.105.197:3000//post/'+post+'">post</a></span></li>')
    }else{
